...
Class Database {
    private $dsn = "mysql:host=localhost;dbname=reactbackend";
    private $dbuser = "root";
    private $dbpass = "";
    public $conn;
...
/*
Class Database {
    private $dsn = "mysql:host=sql311.epizy.com;dbname=epiz_30313225_hosttest";
    private $dbuser = "epiz_30313225";
    private $dbpass = "Xj6VQxXMQFvo35i";
    public $conn;
...
//
//Account Register
if (isset($_POST['fname']) || isset($_POST['sname']) || isset($_POST['email']) || isset($_POST['psw'])) {
    $fname = $db->test_input($_POST['fname']);
    $sname = $db->test_input($_POST['sname']);
    $email = $db->test_input($_POST['email']);
    $pass = $db->test_input($_POST['psw']);

$signup = $db->signup($fname,$sname,$email,$pass);
